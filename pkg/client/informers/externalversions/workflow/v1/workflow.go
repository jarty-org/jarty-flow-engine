...
import (
	...
	versioned "github.com/jartyorg.io/jarty-flow-engine/pkg/client/clientset/versioned"
	internalinterfaces "github.com/jartyorg.io/jarty-flow-engine/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/jartyorg.io/jarty-flow-engine/pkg/client/listers/workflow/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.JartyorgV1().Workflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JartyorgV1().Workflows(namespace).Watch(context.TODO(), options)
			},
		},
		&workflowv1.Workflow{},
		resyncPeriod,
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workflowv1.Workflow{}, f.defaultInformer)
}
